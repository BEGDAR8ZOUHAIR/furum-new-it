<x-guest-layout>
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <section class="flex flex-col col-span-4 sm:col-span-3 gap-y-4">
                        ...
                        <x-form action="{{ route('threads.store') }}">
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    {{-- <x-form.input id="body" class="block shadow-inner bg-gray-100 w-full" type="text" name="body"  autofocus /> --}}
                                    <x-textarea name="body" id="" class="block shadow-inner bg-gray-100 h-56 w-full" cols="30" rows="10"></x-textarea>
